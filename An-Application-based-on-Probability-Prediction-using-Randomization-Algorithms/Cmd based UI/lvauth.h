...
if(((a+c)%10)==((b+d)%10))
		...
		//printf("\nBanker\n");
                                ...
                                /*tempthreadstruct =  win(id,j,k,l);
				threadstruct.PL +=counter.PL;
				threadstruct.BA +=counter.BA;		
				threadstruct.TI +=counter.TI;
				threadstruct.CO +=counter.CO;
				printf("\n%ld %ld %ld %ld\n",counter.PL,counter.BA,counter.TI,counter.CO);
				printf("\n%ld %ld %ld %ld \n",tempthreadstruct.PL,tempthreadstruct.BA,tempthreadstruct.TI,tempthreadstruct.CO);
			*/}
			}
			}//}
		P+=counter.PL;	
